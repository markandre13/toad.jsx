...
export const BooleanAttributes = /*#__PURE__*/ new Set(booleans);

export const Properties = /*#__PURE__*/ new Set([
...
export const ChildProperties = /*#__PURE__*/ new Set([
  "innerHTML",
  "textContent",
  "innerText",
  "children"
...
// React Compat
export const Aliases = /*#__PURE__*/ Object.assign(Object.create(null), {
  className: "class",
  htmlFor: "for"
});
...
export function getPropAlias(prop: string, tagName: string) {
  const a = PropAliases[prop];
  return typeof a === "object" ? (a[tagName] ? a["$"] : undefined) : a;
}

// list of Element events that will be delegated
export const DelegatedEvents = /*#__PURE__*/ new Set([
  "beforeinput",
  "click",
  "dblclick",
  "contextmenu",
...
export const DOMElements = /*#__PURE__*/ new Set([
  "html",
  "base",
  "head",
  "link",
